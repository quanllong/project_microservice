...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("E:\\code\\microservice\\guns\\project_microservice\\guns\\guns-rest\\src\\main\\java");//这里写你自己的java目录
        gc.setFileOverride(true);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("wuqiagnqiang");
        ...
        strategy.setInclude(new String[]{"mtime_user_t"}); /*表名*/
        ...
        pc.setServiceImpl("com.stylefeng.guns.rest.modular.service");   //本项目没用，生成之后删掉
