...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("G:\\Java_IDEA\\microservice\\project\\project_microservice\\guns\\guns-pay\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mtime_film_t"}); /*表名*/
